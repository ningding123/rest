...
!function(t, e) {
	...
	return function(t) {
		...
		function W(t, e) {
			...
			for (s = 0; s < a.length;) n[a[s].identifier] && r.push(a[s]), e & (Nt | It) &&
				delete n[a[s].identifier]
				, s++;
			return r.length ? [ y(o.concat(r), "identifier", !0), r ] : void 0
		}
		function H() {
			x.apply(this, arguments);var t = l(this.handler, this);
		...
		s.removeSession = function(t) {
			...
			if (this.doLog = s.doLog, this.options = o({}, s.defaults), o(this.options, t), this.options.debug && (this.options.logging = !0), l) {
				...
				this.session = this.session || v;try {
					if (!localStorage)
						throw new Error("localStorage is not defined");
			...
			n.flexslider = function(t, i) {
				...
				n.data(t, "flexslider", s), g = {
						...
						setupPaging : function() {
							...
							if (s.controlNavScaffold = n('<ol class="' + r + "control-nav " + r + i + '"></ol>'), s.pagingCount > 1)
								for (var a = 0; a < s.pagingCount; a++) {
									e = s.slides.eq(a), void 0 === e.attr("data-thumb-alt") && e.attr("data-thumb-alt", "");var l = "" !== e.attr("data-thumb-alt") ? l = ' alt="' + e.attr("data-thumb-alt") + '"' : "";
					...
					touch : function() {
						...
						function n(i) {
							i.stopPropagation();var n = i.target._slider;
							if (n) {
						...
						function o(t) {
							t.stopPropagation();var e = t.target._slider;
							if (e) {
					...
					if (s.vars.animationLoop || t === s.currentSlide || (s.direction = t > s.currentSlide ? "next" : "prev"), v && 1 === s.pagingCount && (s.direction = s.currentItem < t ? "next" : "prev"), !s.animating && (s.canAdvance(t, a) || i) && s.is(":visible")) {
						...
						if (s.animating = !0, s.animatingTo = t, e && s.pause(), s.vars.before(s), s.syncExists && !a && g.sync("animate"), s.vars.controlNav && g.controlNav.active(), m || s.slides.removeClass(r + "active-slide").eq(t).addClass(r + "active-slide"), s.atEnd = 0 === t || t === s.last, s.vars.directionNav && g.directionNav.update(), t === s.last && (s.vars.end(s), s.vars.animationLoop || s.pause()), f)
							c ? (s.slides.eq(s.currentSlide).css({
								...
								opacity : 1
							}, s.vars.animationSpeed, s.vars.easing, s.wrapup));else {
							var u,
								h,
								y,
					...
					if (f) s.slides.css({
							...
							opacity : 1
						}, s.vars.animationSpeed, s.vars.easing)), s.vars.smoothHeight && g.smoothHeight();else {
						var e,
							i;
		...
		n.prototype = {
			...
			handleEvent : function(t) {
				...
				case "mousecancel":
					this._end(t);
					break;case "orientationchange":
				case "resize":
					this._resize();
					break;case "transitionend":
		...
		d.prototype.createDefault = function(t) {
			...
			createQrcode : function() {
				for (var t = 0, e = 0, i = null, n = 0; n < 8; n++) {
					this.makeImpl(n);var s = f.getLostPoint(this);
		...
		function s() {
			...
			l && h.setIcon(new BMap.Icon(l, new BMap.Size(40, 40)));var d = {
					width : 200,
					title : n
				},
