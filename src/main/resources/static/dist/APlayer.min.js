...
APlayer.prototype.init = function() {
    ...
    if (this.element.innerHTML = '<div class="aplayer-pic"><div class="music-player__image"><img width="120%" src="' + this.music.pic + '" alt=""></div><div class="music-player__pointer"><img width="100%" src="./img/pc/cd_tou.png" alt=""></div><div class="aplayer-button aplayer-pause aplayer-hide"><i class="demo-icon aplayer-icon-pause"></i></div><div class="aplayer-button aplayer-play"><i class="demo-icon aplayer-icon-play"></i></div></div><div class="aplayer-info"><div class="aplayer-music"><span class="aplayer-title">' + this.music.title + '</span><span class="aplayer-author"> - (＞﹏＜)加载中,好累的说...</span></div><div class="aplayer-lrc"><div class="aplayer-lrc-contents" style="transform: translateY(0);"></div></div><div class="aplayer-controller"><div class="aplayer-bar-wrap"><div class="aplayer-bar"><div class="aplayer-loaded" style="width: 0"></div><div class="aplayer-played" style="width: 0"><span class="aplayer-thumb"></span></div></div></div><div class="aplayer-time"> - <span class="aplayer-ptime">00:00</span> / <span class="aplayer-dtime">(oﾟ▽ﾟ)</span><div class="aplayer-volume-wrap"><i class="demo-icon aplayer-icon-volume-down"></i><div class="aplayer-volume-bar-wrap"><div class="aplayer-volume-bar"><div class="aplayer-volume" style="height: 80%"></div></div></div></div></div></div></div>', this.option.showlrc) {
...
APlayer.prototype.play = function() {
	this.pointer = this.element.getElementsByClassName("music-player__pointer")[0];
	this.pointer1 = this.element.getElementsByClassName("music-player__image")[0];
	this.pointer.classList.add("play");
	this.pointer1.classList.add("play1");
...
APlayer.prototype.pause = function() {
	this.pointer = this.element.getElementsByClassName("music-player__pointer")[0];
	this.pointer1 = this.element.getElementsByClassName("music-player__image")[0];
	this.pointer.classList.remove("play");
	this.pointer1.classList.remove("play1");
