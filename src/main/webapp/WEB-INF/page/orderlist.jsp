...
<div class="tpl-page-container">
    ...
    <div class="tpl-content-wrapper">
        <ol class="am-breadcrumb">
            ...
            <li><a href="javascript:void(0)">送检单管理</a></li>
            <li class="am-active">送检单列表</li>
        </ol>
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>送检单列表
                </div>
                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    ...
                                    <th class="table-date am-hide-sm-only">是否需要送检</th>
                                ...
                                <c:forEach items="${orderPage.rows }" var="item">
                                    ...
                                    <td>
                                        <c:if test="${item.sstatus ==0 }">否</c:if>
                                        <c:if test="${item.sstatus ==1 }">是</c:if>
                                    </td>
                                    <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="window.location.href='songorder/echodata?id='+${item.id}"><span class="am-icon-pencil-square-o"></span>送检单生成</button>
                                            </div>
                                        </div>
                                    </td>
                                    </tr>
