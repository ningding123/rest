...
<div class="tpl-content-wrapper">
	<ol class="am-breadcrumb">
		...
		<li><a href="javascript:void(0)">看病单管理</a>
		</li>
		<li class="am-active">看病单更新</li>
	</ol>
	<div class="tpl-portlet-components">
		<div class="portlet-title">
			<div class="caption font-green bold">
				<span class="am-icon-code"></span>看病单更新
			</div>
		...
		<div class="tpl-block ">
			<div class="am-g tpl-amazeui-form">
				<div class="am-u-sm-12 am-u-md-9">
					<form  id="art_insert_form" class="am-form am-form-horizontal" action="order/update" method="post">
						<input type="hidden" value="${order.id}" name="id">
						<div class="am-form-group">
							<label  class="am-u-sm-3 am-form-label">看病单编号</label>
							<div class="am-u-sm-9">
						...
						<div class="am-form-group">
							<div class="am-u-sm-9 am-u-sm-push-3">
								<button type="button" onclick="checkphone()" class="am-btn am-btn-primary" id="edit">更新看病单</button>
							</div>
						</div>
					</form>
				</div>
