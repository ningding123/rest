...
<div class="tpl-page-container">
    ...
    <div class="tpl-content-wrapper">
        <ol class="am-breadcrumb">
            ...
            <li><a href="javascript:void(0)">送检单回执管理</a></li>
            <li class="am-active">送检单回执列表</li>
        </ol>
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>送检单回执列表
                </div>
                                    ...
                                    <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="window.location.href='returnorder/echodata?id='+${item.id}"><span class="am-icon-pencil-square-o"></span>回执</button>
                                            </div>
                                        </div>
                                    </td>
                                    </tr>
