...
<div class="tpl-page-container">
    ...
    <div class="tpl-content-wrapper">
        <ol class="am-breadcrumb">
            ...
            <li><a href="javascript:void(0)">学员队管理</a></li>
            <li class="am-active">审核列表</li>
        </ol>
        <div class="tpl-portlet-components">
            <div class="portlet-title">
                <div class="caption font-green bold">
                    <span class="am-icon-code"></span>审核列表
                </div>
                    ...
                    <div class="am-u-sm-12">
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <c:forEach items="${page.rows }" var="item">
                                    ...
                                    <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="change(${item.id})"><span class="am-icon-pencil-square-o"></span>审核通过</button>
                                            </div>
                                        </div>
                                    </td>
                                    </tr>
                            ...
                            <div class="am-cf">
                                ...
                                <div class="am-fr">
                                    <nun:page url="student/checklist"></nun:page>
                                </div>
                            </div>
                            <hr>
...
<script type="text/javascript">
    function change(id) {
        layer.confirm("是否要审核通过?", {
            icon: 1,
            skin: 'layui-layer-lan',
            //closeBtn: 0,
            btn: ['通过','取消'] //按钮
        }, function(){
            var url = "student/check";
            data={};
            data["id"] = id;
            fajax(url,data,function(data){
                if(data.status=="succ"){
                    layer.msg("审核成功");
                    setTimeout(function(){ window.location.href="student/checklist";},1000)
